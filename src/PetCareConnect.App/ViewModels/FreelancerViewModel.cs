...
{
    public class FreelancerViewModel : BaseEntity
    {
        [Key]
        ...
        [Required(ErrorMessage = "Selecione o tipo de Serviço que será prestado.")]
        public TipoPrestador TipoPrestador { get; set; }

        /* EF Relational */
        public EnderecoFreelancerViewModel EnderecoFreelancerViewModel { get; set; }
    }

    public class EnderecoFreelancerViewModel : BaseEntity
    {
        [Key]
